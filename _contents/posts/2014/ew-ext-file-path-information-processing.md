...
type: posts
series: false
date: 2014-11-07T23:32:00.791Z
tags: [Dreamweaver]
description: //browseFile(fieldToStoreURL){//getFullPath(filePathURL){//getSimpleFileName() {//fixUpPath(docURL,siteURL,savedPath)//fileIsCurrentlyOpen(absoluteFil...
draft: false 
cover: false
---
